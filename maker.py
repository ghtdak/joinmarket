...
class CoinJoinOrder(object):
    ...
    def handle_modified_orders(self, to_cancel, to_announce):
        ...
        if len(to_announce) > 0:
            ...
            for ann in to_announce:
                oldorder_s = [order for order in self.maker.orderlist
    ...
    def verify_unsigned_tx(self, txd):
        tx_utxos = set([ins['outpoint']['hash'] + ':' + str(
    ...
    def on_privmsg(self, nick, message):
        ...
        for command_line in command_lines:
            ...
            try:
                ...
                if chunks[0] == 'fill':
                    if nick in self.active_orders and self.active_orders[nick
                                                         ] != None:
                    ...
                    if nick not in self.active_orders or self.active_orders[nick
                                                            ] == None:
